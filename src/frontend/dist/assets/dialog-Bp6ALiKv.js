import { c as createLucideIcon, r as reactExports, o as useControllableState, j as jsxRuntimeExports, p as useId, P as Presence, q as Primitive, s as composeEventHandlers, v as Portal$2, w as useComposedRefs, x as hideOthers, y as createContext2, z as createContextScope, A as ReactRemoveScroll, C as useFocusGuards, F as FocusScope, D as DismissableLayer, E as createSlot, G as createSlottable, b as cn, H as buttonVariants, I as useDirection, J as Root2$2, K as Anchor, M as useLayoutEffect2, N as reactDomExports, O as createPopperScope, Q as createCollection, S as useCallbackRef, U as Content$1, V as Arrow, W as ChevronDown, B as Button, X } from "./index-CS2BT5n9.js";
/**
...
function ConfirmDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": ocid ? `${ocid}.dialog` : void 0, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          disabled: isLoading,
          "data-ocid": ocid ? `${ocid}.cancel_button` : void 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        AlertDialogAction,
        {
          ...
          "data-ocid": ocid ? `${ocid}.confirm_button` : void 0,
          children: isLoading ? "Deleting…" : confirmLabel
        }
      )
    ] })
  ] }) });
...
function EmptyState({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": ocid ? `${ocid}.empty_state` : void 0,
      children: [
        Icon2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-14 w-14 items-center justify-center rounded-full bg-muted", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-7 w-7 text-muted-foreground" }) }),
        ...
        actionLabel && onAction && /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            size: "sm",
            className: "mt-2",
            "data-ocid": ocid ? `${ocid}.empty_state.primary_button` : void 0,
