import { c as createLucideIcon, d as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, e as clsx, R as React, i as invariant, j as jsxRuntimeExports, b as cn, T as TrendingUp, L as Link, B as Button, f as format$1, h as LoadingSpinner } from "./index-CS2BT5n9.js";
import { C as CategoryBadge, u as useDashboardSummary } from "./useTransactions-B5pdmf53.js";
import { P as PageHeader } from "./PageHeader-Drc5o7X6.js";
import { T as TrendingDown, u as useBudgets, W as Wallet } from "./useBudgets-8H6J8Fc3.js";
/**
...
P.toPrecision = function(sd, rm) {
  ...
  if (sd === void 0) {
    e3 = getBase10Exponent(x2);
    str = toString$1(x2, e3 <= Ctor.toExpNeg || e3 >= Ctor.toExpPos);
  } else {
    ...
    e3 = getBase10Exponent(x2);
    str = toString$1(x2, sd <= e3 || e3 <= Ctor.toExpNeg, sd);
  }
  return str;
};
...
P.toString = P.valueOf = P.val = P.toJSON = P[Symbol.for("nodejs.util.inspect.custom")] = function() {
  ...
  return toString$1(x2, e3 <= Ctor.toExpNeg || e3 >= Ctor.toExpPos);
};
function add(x2, y2) {
...
function createEqualityComparator({ areArrayBuffersEqual: areArrayBuffersEqual2, areArraysEqual: areArraysEqual2, areDataViewsEqual: areDataViewsEqual2, areDatesEqual: areDatesEqual2, areErrorsEqual: areErrorsEqual2, areFunctionsEqual: areFunctionsEqual2, areMapsEqual: areMapsEqual2, areNumbersEqual: areNumbersEqual2, areObjectsEqual: areObjectsEqual2, arePrimitiveWrappersEqual: arePrimitiveWrappersEqual2, areRegExpsEqual: areRegExpsEqual2, areSetsEqual: areSetsEqual2, areTypedArraysEqual: areTypedArraysEqual2, areUrlsEqual: areUrlsEqual2, unknownTagComparators }) {
  return function comparator(a2, b2, state) {
    ...
    if (tag === ARRAY_BUFFER_TAG) {
      return areArrayBuffersEqual2(a2, b2, state);
    }
    if (tag === DATA_VIEW_TAG) {
      return areDataViewsEqual2(a2, b2, state);
    }
...
function CustomTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-border bg-card px-3 py-2 shadow-elevated text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-1.5", children: label }),
    payload.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-0.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground capitalize", children: entry.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto font-semibold tabular-nums text-foreground", children: formatCurrency(entry.value) })
    ] }, entry.name))
  ] });
}
...
function MonthlyBarChart({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("w-full", className), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data, barGap: 3, barSize: 13, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      CartesianGrid,
      {
        strokeDasharray: "3 3",
...
function StatCard({
  ...
  const trendColor = trendDirection === "up" ? "text-income" : trendDirection === "down" ? "text-expense" : "text-muted-foreground";
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-lg bg-card p-5 shadow-card border border-border",
        "data-ocid": ocid ? `${ocid}.loading_state` : void 0,
        children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: cn("h-5 w-5", iconColor) })
            }
          ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-display text-2xl font-bold tabular-nums text-foreground", children: value })
        ] })
      ]
    }
  );
...
function RowSkeleton({ index }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { "data-ocid": `dashboard.transaction.loading.${index}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pl-5 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-14" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-40" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-5 w-20 rounded-full" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-5 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-16 ml-auto" }) })
  ] });
}
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-5 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground", children: "Recent Transactions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/transactions", tabIndex: -1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "ghost",
              size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full min-w-[480px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2.5 pl-5 pr-4 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Date" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2.5 pr-4 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Description" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2.5 pr-4 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2.5 pr-5 text-right text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Amount" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: isLoading ? (
            /* Loading skeleton rows */
            Array.from({ length: 5 }, (_, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(RowSkeleton, { index: i + 1 }, `skeleton-${i + 1}`))
            ...
            /* Transaction rows */
            transactions.map((tx, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "tr",
              {
                className: "hover:bg-muted/40 transition-fast",
                "data-ocid": `dashboard.transaction.item.${i + 1}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pl-5 pr-4 text-sm text-muted-foreground whitespace-nowrap", children: formatShortDate(tx.date) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4 text-sm font-medium text-foreground max-w-[200px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block truncate", title: tx.description, children: tx.description }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 pr-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBadge, { category: tx.category }) }),
...
function filterActiveChartDays(data) {
  ...
  const trimmed = lastActiveIndex >= 0 ? data.slice(0, lastActiveIndex + 1) : data;
  return trimmed.map((d2) => ({
    month: d2.month,
    income: d2.income,
...
function DashboardPage() {
  ...
  const chartData = reactExports.useMemo(
    () => filterActiveChartDays((summary == null ? void 0 : summary.monthlyData) ?? []),
    [summary]
  );
  const topBudgets = reactExports.useMemo(() => (budgets ?? []).slice(0, 3), [budgets]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "dashboard.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        subtitle: `Current ${format$1(/* @__PURE__ */ new Date(), "MMMM d, yyyy")}`
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-4 sm:grid-cols-2 xl:grid-cols-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          ...
          trend: summary && summary.savingsRate > 0 ? `${summary.savingsRate}% saved` : void 0,
          trendDirection: "up",
          icon: PiggyBank,
          iconBg: "bg-accent/10",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4", children: "Cash Flow: Income vs. Expenses (This Month)" }),
            summaryLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              LoadingSpinner,
              {
                size: "md",
                label: "Loading chart…",
            ...
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(MonthlyBarChart, { data: chartData, height: 220 })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground mb-4", children: "Budget Performance" }),
            budgetsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "md", label: "Loading…", className: "py-8" }) : topBudgets.length === 0 ? (
              /* Empty state */
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-8 text-center gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", "aria-hidden": "true", children: "🎯" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No budgets set yet." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/app/budget", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    size: "sm",
                    variant: "outline",
                    "data-ocid": "dashboard.set_budget.button",
                    children: "Set a Budget"
                  }
                ) })
              ] })
            ) : (
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
                topBudgets.map((budget, i) => {
                  ...
                  const barColor = pct >= 100 ? "bg-expense" : pct >= 80 ? "bg-accent" : "bg-income";
                  const textColor = pct >= 100 ? "text-expense" : pct >= 80 ? "text-accent" : "text-income";
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryBadge, { category: budget.category }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "span",
                            {
                              className: cn(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RecentTransactions,
      {
        transactions: (summary == null ? void 0 : summary.recentTransactions) ?? [],
        isLoading
      }
    )
  ] });
